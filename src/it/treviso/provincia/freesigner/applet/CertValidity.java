...
import it.treviso.provincia.freesigner.applet.Configuration;
import it.treviso.provincia.freesigner.crl.CertificationAuthorities;
import it.treviso.provincia.freesigner.crl.X509CertRL;
...
class CertValidity {
     ...
     * <br> è infatti comunque necessaria per la verifica della validità del
    ...
    public boolean isCRLChecked() {
        return ((conf.getCRLupdate() || isDownloadCRLForced) && "".equals(getCRLerror()) );
    }
     ...
     *  Restituisce true se il certificato è scaduto
     *
