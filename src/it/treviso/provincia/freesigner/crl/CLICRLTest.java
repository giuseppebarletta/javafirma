...
public class CLICRLTest {
    ...
    public boolean verifica() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Il file firmato è in formato DER");
                certData = risultato;
            ...
            while (it.hasNext()) {
                ...
                if (certCollection.size() == 1) {
                    ...
                    // NB verifica integrità del doc e non-scadenza del cert sono fatte in CLITest
    ...
    public static void main(String[] args) throws IOException, CMSException,
        ...
        CLICRLTest prova = new CLICRLTest(args[0], args[1]);
        prova.verifica();
    }
}
